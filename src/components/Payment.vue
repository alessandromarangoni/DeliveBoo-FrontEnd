...
import AppFooter from '../components/main-sections/AppFooter.vue';
...
<template>
    ...
    <div class="paddingLeftMd100 paddingLeftSm0 ">
    ...
    <div class="position-relative">
        <div class="bg-custom position-absolute bottom-0 bottom-sm-80">
...
.content {
    ...
    border-radius: 10px;
    box-shadow: -3px -3px 7px #ffffffb0, 2px 2px 5px rgba(94, 104, 121, 0.288);
}
