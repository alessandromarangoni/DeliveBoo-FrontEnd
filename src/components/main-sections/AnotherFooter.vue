...
<template>
    <div class="container-fluid d-flex align-items-center justify-content-between flex-md-row flex-column">

        <div class="d-flex align-items-center ">

            <h6 class="p-1 mb-0 text-light">Devs:</h6>
            <a target=”_blank” href="https://github.com/Emanuelediscala" class="p-1 text-light">Emanuele</a>
            <a target=”_blank” href="https://github.com/marcogiammari" class="p-1 text-light">Marco</a>
            <a target=”_blank” href="https://github.com/alessandromarangoni"  class="p-1 text-light">Ale</a>
            <a target=”_blank” href="https://github.com/Ahri-code"  class="p-1 text-light">Edy</a>
            <a target=”_blank” href="https://github.com/GiorgioFontana-12"  class="p-1 text-light">Giorgio</a>
...
.my-card .social-link1,.my-card .social-link2,.my-card .social-link3,.my-card .social-link4 {
  position: relative;
  display: flex;
  align-items: center;
...
.my-card .social-link2:hover {
  background-color: #00ccff;
  animation: bounce_613 0.4s linear;
}

.my-card .social-link3:hover {
  background-color: #5865f2;
  animation: bounce_613 0.4s linear;
}

.my-card .social-link4:hover {
